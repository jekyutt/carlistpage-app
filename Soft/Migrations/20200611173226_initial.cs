    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BikeMarks", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    BikeMarkId = table.Column<string>(nullable: true),
                    BikeBodyType = table.Column<string>(nullable: true),
                    BikePower = table.Column<string>(nullable: true),
                    BikeAcceleration = table.Column<string>(nullable: true),
                    MaxSpeed = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BikeModels", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesStatements", x => x.Name);
                });
